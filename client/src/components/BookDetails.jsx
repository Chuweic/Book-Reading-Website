...
export default function BookDetails() {
    ...
    const [selectedBook, setSelectedBook] = useState(null); // this is used to redirect the user to the book details page
    ...
    const storedBook = selectedBook
      ? readList.find((object) => object.bookId === selectedBook.bookId)
      : null;
    const readListDisabled = Boolean(storedBook); // if the book is already in the read list, disable the button
            ...
            {selectedBook && (
                ...
                <div className="book-details">
                    <div className="cover-wrapper">
                        {selectedBook.isbn ? (
                        <img
                            src={`https://covers.openlibrary.org/b/olid/${selectedBook.isbn}-M.jpg`}
