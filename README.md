...
<img width="1435" height="817" alt="截屏2025-10-31 23 59 43" src="https://github.com/user-attachments/assets/5468e8b3-7ad5-42e1-ac18-5c48f38c5cdf" />

- **Book details:** Provides summaries, metadata, and cover art for each book using dynamic routes.
<img width="1436" height="539" alt="截屏2025-10-31 23 59 57" src="https://github.com/user-attachments/assets/5566f8fc-42a4-4e29-adae-0b405f0f40f2" />
<img width="1469" height="709" alt="截屏2025-11-01 00 00 16" src="https://github.com/user-attachments/assets/2eccbefa-d4d1-4640-954c-9aaeb6f4d632" />
...
<img width="403" height="656" alt="截屏2025-11-01 00 01 00" src="https://github.com/user-attachments/assets/c5a5375e-c704-4441-be0c-c94f49e2d66a" />
...
```
assignment-03/
├── api/                 # Express API with Auth0-protected routes and Prisma client
├── client/              # React application (Create React App)
│   ├── src/components/  # SPA views and reusable UI pieces
│   ├── src/context/     # Global state for reading list & Auth0 token helpers
│   └── src/style/       # Component-scoped CSS
├── prisma/              # Prisma schema and migrations
├── vercel.json          # Vercel monorepo build configuration for the client
